...
//        final OnLongClickListener tabLongClickListener = new TabLongClickListener();
...
//                @Override
//                public void run() {
//                    final View view_addlist = LayoutInflater.from(getContext()).inflate(R.layout.dialog_addlista, null);
//                    final AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
//                    final EditText new_list = (EditText) view_addlist.findViewById(R.id.et_name_list);
//                    final int position = mViewPager.getCurrentItem();
//                    final List<ListOfUser> listOfUserList = new DAO_List(getContext()).findAll();
//
...
//                                        new DAO_List(getContext()).edit(listOfUser);
...
//                                    if(listOfUserList.size() == 1){
//                                        Toast.makeText(getContext(), "É necessário haver uma tab no app.", Toast.LENGTH_SHORT).show();
//                                    }else {
//                                        new DAO_List(getContext()).remove(listOfUser);
//                                        new DAO_ListSerie(getContext()).remove(listOfUser);
